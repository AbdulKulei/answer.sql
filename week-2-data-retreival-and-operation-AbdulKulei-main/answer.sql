...
-- Retrieve billID, itemDescription, and LineTotal from the bill_items table where LineTotal is greater than 100 and order the result in descending order using billID
